...
function getAllUrls(str: string) {
  return Array.from(getUrls(str, {...NORMALIZE_URL_OPTIONS, requireSchemeOrWww: true}));
}
 ...
 * @param pages
 */
export async function getPageUrls(params: GetPageUrlsParams): Promise<ScrapeRequestResult> {
